...
@endsection
@section('page_title','SubCategories| Add')
@section('content')
                    ...
                    <form method="post" action="{{route('subcategories.categories.store', $category)}}" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        {{$errors->first()}}
                            ...
                            <div class="form-group row">
                                <label for="category_name" class="col-sm-3 text-right control-label col-form-label">SubCategories Name</label>
                                <div class="col-sm-9">
