...
@endsection
@section('page_title', __('dashboard.cities').' | '.__('dashboard.edit'))
@section('content')
                    ...
                    <form method="post" action="{{route('cities.update', $city->id)}}" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        {{$errors->first()}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input name="name" value="{{$city->name??old('name')}}" type="text" class="form-control" id="brand_name" placeholder="{{__('site.name')}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="shipping" class="col-sm-3 text-right control-label col-form-label">{{__('site.shipping')}}</label>
                                <div class="col-sm-9">
                                    <input name="shipping" value="{{$city->shipping??old('shipping')}}" type="number" class="form-control" id="shipping" placeholder="{{__('site.shipping')}}">
                                </div>
                            </div>
                        </div>
